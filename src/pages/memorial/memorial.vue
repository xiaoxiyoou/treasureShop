<template>
  <div class="container">
    <div class="item">
      <img class="banner" src="./banner1.png" alt="">
      <div class="btm row j-b a-c">
        <div class="left ">
          <div class="title">家族宝品牌专属</div>
          <div class="des">已有<span style="color:#b2a189">12923</span>人制作</div>
        </div>
        <div class="right row ">
    ...
    <div class="item">
      <img class="banner" src="./banner2.png" alt="">
      <div class="btm row j-b a-c">
        <div class="left ">
          <div class="title">陀罗尼经被主题</div>
